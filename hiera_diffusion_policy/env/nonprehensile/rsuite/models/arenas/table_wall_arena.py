...
class TableWallArenaX(Arena):
    ...
    def __init__(
        ...
        has_legs=True,
        xml="arenas/table_wall_arena_x+.xml",
    ):
        ...
        self.wall_collision = self.table_body.find("./geom[@name='wall_collision']")
        self.wall_visual = self.table_body.find("./geom[@name='wall_visual']")
    ...
    def configure_location(self):
        ...
        self.wall_collision.set("pos", array_to_string(np.array([0.35, 0, 0.15+self.table_half_size[2]])))
        self.wall_visual.set("pos", array_to_string(np.array([0.35, 0, 0.15+self.table_half_size[2]])))
        self.wall_collision.set("friction", array_to_string(self.table_friction))
        # self.wall_visual.set("size", array_to_string(self.table_half_size))
...
class TableWallArenaY(Arena):
    ...
    def __init__(
        ...
        table_offset=(0, 0, 0.8),
        has_legs=True,
        xml=os.path.join(rs_assets_path(), 'arenas/table_wall_arena_y+.xml')
    ):
        super().__init__(xml_path_completion(xml))
        ...
        # self.wall1_collision = self.table_body.find("./geom[@name='wall1_collision']")
        # self.wall1_visual = self.table_body.find("./geom[@name='wall1_visual']")
    ...
    def configure_location(self):
        ...
        self.wall_collision.set("pos", array_to_string(np.array([0, 0.35-0.025, 0.075+self.table_half_size[2]])))
        self.wall_visual.set("pos", array_to_string(np.array([0, 0.35-0.025, 0.075+self.table_half_size[2]])))
        self.wall_collision.set("friction", array_to_string(self.table_friction))
